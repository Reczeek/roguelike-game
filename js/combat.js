...
const bosses = [
  {
    ...
    attack: 30,
    timeAttack: 1500,
    image: "assets/images/Szczuras.png",
    isBoss: true,
    goldMin: 15,
    goldMax: 30,
  },
  {
    ...
    attack: 40,
    timeAttack: 1600,
    image: "assets/images/GoblinKing.png",
    isBoss: true,
    goldMin: 80,
    goldMax: 150,
  },
...
const upgradeCosts = [
  8, 16, 24, 32, 48, 72, 122, 160, 224, 300, 500, 900, 1300, 1500, 2100,
];
...
const tempBonuses = [
  {
    name: "+5% atak",
    apply: function () {
      player.attack = Math.floor(player.attack * 1.05);
    },
  },
  {
    name: "+10% max HP",
  ...
  },
  {
    name: "+10% 💰 z walk",
    apply: function () {
      player.skills.goldBonus += 10;
    },
  },
  {
    name: "+5% krytyk",
    apply: function () {
      player.equipment.weapon.critChance += 5;
    },
  },
  {
    name: "Regeneracja +10 HP/s",
    apply: function () {
      player.equipment.accessory.regen += 10;
    },
  },
  {
    name: "+5% szansa kontratak",
    apply: function () {
      player.equipment.ringDefense.counterChance += 5;
    },
  },
];
